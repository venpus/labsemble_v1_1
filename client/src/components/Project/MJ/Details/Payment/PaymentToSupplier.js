...
import { Building2, CreditCard, Calendar, CheckCircle, Save, AlertTriangle } from 'lucide-react';
...
const PaymentToSupplier = ({ isAdmin, isAdminLoading, project, onDataChange }) => {
  ...
  // 데이터 변경 감지
  React.useEffect(() => {
    const hasChanges = JSON.stringify(paymentData) !== JSON.stringify(initialPaymentData);
  ...
  }, [paymentData, initialPaymentData, onDataChange]);
  ...
  const progressPercentage = subtotal > 0 ? Math.round((totalPaidAmount / subtotal) * 100) : 0;
      ...
      <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">단가 × 수량</p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-lg border border-orange-200 p-3 flex-1 max-w-md">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-xs text-gray-600">
                ¥{totalPaidAmount.toLocaleString()} / ¥{subtotal.toLocaleString()}
              </div>
              ...
              <div className="flex items-center">
                ...
                {hasUnsavedChanges && (
                  <div className="ml-3 flex items-center">
                    ...
                    <span className="text-sm text-orange-600 font-medium">저장되지 않은 변경사항</span>
                  </div>
                )}
              </div>
